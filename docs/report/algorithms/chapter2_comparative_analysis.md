...
| Алгоритм | Параметр | Значение по умолчанию (основное сравнение) | Перебиралось ли в анализе гиперпараметров |
|---|---|---|---|
| TS | `max_iterations` | 500 | нет |
| TS | `neighborhood_size` | 25 | да (10 / **25** / 50) |
| TS | `tabu_tenure` | 20 | да (10 / **20** / 40) |
| GA | `population_size` | 100 | да (50 / **100** / 200) |
| GA | `gene_mut_indpb` | 0.1 | да (0.05 / **0.1** / 0.2) |
| SA | `initial_temperature` | 50.0 | да (10 / **50** / 200) |
| SA | `cooling_rate` | 0.995 | да (0.99 / **0.995** / 0.999) |
| SA | `min_temperature` | 1e-3 | нет |
| SA | `max_iterations` | 20 000 | нет |
| CP-SAT | `max_time_in_seconds` | 30.0 | нет (были 1 / 5 / 15) |
