# II.4. Программирование ограничений (Constraint Programming / CP-SAT)
...
### Стабильность решения при изменении временного бюджета
...
```mermaid
xychart-beta
    title "Рисунок II.3. Фактическое время вычислений при изменении бюджета"
    x-axis ["Лимит 1 с", "Лимит 5 с", "Лимит 15 с"]
    y-axis "Время (мс)" 0 --> 250
    bar [211, 209, 205]
...
Результаты применения CP-SAT подтверждают высокую эффективность математических методов для рассматриваемых размерностей. При изменении лимита времени от 1 до 15 секунд фактическое время выполнения остается практически неизменным (~200–210 мс), что свидетельствует о быстром нахождении солвером глобально оптимального решения.

*Рисунок II.14. Стабильность времени работы солвера при увеличении лимитов*

```mermaid
xychart-beta
    title "Рисунок II.14. Время выполнения CP-SAT при различных лимитах"
    x-axis ["Лимит 1 с", "Лимит 5 с", "Лимит 15 с"]
    y-axis "Время (мс)" 0 --> 250
    bar [211, 209, 205]
