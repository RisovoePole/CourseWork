# II.2. Имитация отжига (Simulated Annealing)
...
*Рисунок II.7. Сходимость SA: динамика soft-штрафов (medium)*

```mermaid
xychart-beta
    title "Рисунок II.7. Сходимость SA (дискретные итерации)"
    x-axis "Итерации" [0, 150, 450, 750, 1050, 1350, 1650, 2150]
    y-axis "Soft-штрафы" 0 --> 30
    line [28.1, 22.2, 22.9, 18.8, 15.4, 9.1, 7.1, 3.3]
    line [28.0, 28.4, 26.0, 21.9, 11.0, 6.5, 4.6, 3.6]
    line [22.3, 20.6, 26.2, 19.7, 10.6, 7.0, 4.9, 2.0]
...
*Рисунок II.12. Влияние начальной температуры на качество решения (cooling_rate = 0.999)*

```mermaid
xychart-beta
    title "Рисунок II.12. Зависимость штрафа от начальной температуры"
