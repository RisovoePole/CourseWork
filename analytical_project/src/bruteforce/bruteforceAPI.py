from src.bruteforce.bruteforceCore import enumerate_schedules_backtracking, enumerate_schedules_parallel, schedules_count_for_size, total_vectors_count
from src.config import ALGORITHM_MAX_PAIRS_PER_DAY
from src.bruteforce.rules import (
    ConstraintEngine,
    MaxPairsPerDayRule,
